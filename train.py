...
def train(args, model, train_dataloader, valid_dataloader):
    ...
    if args.bitfit:
        ...
        trainable_names = []
        trainable_components = ['encode_proj', 'bias']
                    ...
                    if acc >= best_acc:
                        ...
                        if args.model_name_or_path == 'bert':
                            torch.save({'epoch': epoch,
                                       ...
                                       os.path.join(args.output_dir, "save_model_best.pt"))
                        else:
                            torch.save({'epoch': epoch,
                                        'model': model.state_dict()},
                                       os.path.join(args.output_dir, "save_t5_model_best.pt"))
...
def main():
    ...
    log_name = args.model_name_or_path + '_train'
